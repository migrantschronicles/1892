Shader "World Political Map/FogOfWar Pass 1" {
	Properties {
	...
	SubShader {
		Tags { "RenderType"="Transparent" "Queue"="Transparent+51" "DisableBatching"="True" "ForceNoShadowCasting"="True" "IgnoreProjector"="True" }
